...
import { ActivityTimeline, TimelineEvent } from '@/components/timeline/ActivityTimeline';
    ...
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-gray-500">A chronological feed of all activity: bids, orders, payouts, and messages.</p>
        ...
        <div className="lg:col-span-1 space-y-6">
            ...
            <div className="storefront-grid grid grid-cols-1 gap-6">
              ...
              {/* Call-to-action */}
              <Link href="/dashboard/stores/create" className="storefront-card bg-white p-6 rounded-xl shadow-lg border border-dashed border-gray-300 flex flex-col items-center justify-center text-center hover:bg-gray-50 transition duration-300 cursor-pointer">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                    <li>Pending Payouts: <span className="font-bold text-yellow-600">1.5 ETH</span></li>
                    <li>Open Orders: <span className="font-bold text-blue-600">2</span></li>
                    <li>Unread Messages: <span className="font-bold text-red-600">3</span></li>
                </ul>
            </div>
        </div>
      </div>
