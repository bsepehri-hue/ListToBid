...
export default function PublicMotorcycleDetailPage() {
  ...
  if (loading) {
    return <p className="text-gray-600">Loading motorcycle…</p>;
  }

  if (!listing) {
    return <p className="text-gray-600">Motorcycle not found.</p>;
  }
    ...
    <div className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-6 rounded-xl shadow border">
          ...
          <Spec label="Engine Size" value={`${listing.cc} cc`} />
          ...
          <Spec label="Drive Type" value={listing.drive} />
