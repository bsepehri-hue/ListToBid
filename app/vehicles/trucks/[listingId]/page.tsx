...
export default function PublicTruckDetailPage() {
  ...
  if (loading) {
    return <p className="text-gray-600">Loading truck…</p>;
  }
    ...
    <div className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-6 rounded-xl shadow border">
          ...
          <Spec label="Bed Length" value={listing.bed} />
          <Spec label="Cab Type" value={listing.cab} />
          <Spec label="Towing Capacity" value={`${listing.tow} lbs`} />
